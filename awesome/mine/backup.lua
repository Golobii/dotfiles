...
if awesome.startup_errors then
    naughty.notify({
        ...
        title = "Oops, you fucked up your awesome config!",
...
awful.screen.connect_for_each_screen(function(s)
    ...
    if active_theme == THEMESDIR .. "default" then
...
awful.key({modkey}, "Return", function() awful.spawn(TERMINAL) end,
...
end, {description = "starts firefox", group = "launcher"}),
                              awful.key({modkey, "Shift"}, "b", function()
    awful.spawn.with_shell("firefox -p unsecure")
end, {
    description = "starts firefox with the unsecure profile",
    group = "launcher"
    ...
    awful.spawn.with_shell("xscreensaver-command -lock")
                              ...
                              awful.key({modkey, "Control"}, "c",
                                        function() changeTheme() end, {
    description = "change awesome theme",
    group = "awesome"
...
end, {description = "restore minimized", group = "client"}), -- Laptop Keys
-- VOLUME CONTROL
